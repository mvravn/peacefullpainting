                ...
                <div className="col s12 l8 push-l2">
                    <div className="section">
                        ...
                        <div className="section">
                            ...
                            <p>You can also follow me on different social media and keep tabs on what I am engrossed in at the moment.</p>
                        </div>
                    </div>
                </div>  
            </div>
            <div className="row">
                <div className="section">
                    <div className="col s12 l8 push-l2 center">
                        <img src={window.location.origin + '/images/non-gallery/pplogo_transb.png'} alt="black peacefull painting logo"/>
                        <br/><br/><br/><br/><br/>
                    </div>
                </div>  
            </div>
