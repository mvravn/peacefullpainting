        ...
        return (
            <div>
                <div className="slider" id="banner">
                    <ul className="slides">
                        <li>
                            <img src={window.location.origin + '/images/non-gallery/paint_station_dark.jpg'} alt="paint station"/>
                            <div className="caption center-align">
                                <h1 className="light grey-text text-lighten-3 standout">Peaceful Painting</h1>
                                <br/>
                                <h5 className="light grey-text text-lighten-3 standout">Painting miniatures in peace, getting them ready for WAR!</h5>
                            </div>
                        </li>
                    </ul>
                </div>
                    ...
                    <div className="section">
                        <div className="row">
                            <div className="col s12 l3">
                                <img className="responsive-img" src={window.location.origin + '/images/non-gallery/Vermin_Lord_Corruptor_wip_1.jpg'} alt="Lord Corruptor Head"/>
                            </div>
                            <div className="col s12 l8 push-l1">
                                <h3>1 - You somehow got an idea into your skull?</h3>
                                <p className="flow-text">You know that frustrated feeling when you have a great idea, but you know you just won't get it done? Perhaps it is time you lack or just the skills and patience. Or maybe you know you will never get it done, because you're simply too much of a perfectionist?</p>
                                <p className="flow-text">Don't get annoyed, just get a hold of Peacfull Painting.</p>
                            </div>
                        </div>
                    </div>
                    <div className="section">
                        <div className="row">
                            <div className="col s12 l3 push-l9">
                                <div>
                                    <img className="responsive-img" src={window.location.origin + '/images/non-gallery/Vermin_Lord_Corruptor_wip_2.jpg'} alt="Lord Corruptor Body"/>
                                </div>
                            </div>
                            <div className="col s12 l8 pull-l3">
                                <h3>2 - Flesh out your idea</h3>
                                <p className="flow-text">Maybe find an example or two you can reference and write down your thoughts. Just remember that a picture speaks a thousand words. </p>
                                <p className="flow-text">Simply send me an email, and we'll make sure we understand each other.</p>
                            </div>
                        </div>
                    </div>
                    <div className="section">
