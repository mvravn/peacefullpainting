            ...
            <div className="navbar-fixed">
                <nav className="nav-wrapper blue-grey darken-3">
                    <div className="container">
                        <a href="/" className="brand-logo hide-on-med-and-down" id="nav"><img className="brand-logo" src={window.location.origin + '/images/non-gallery/pplogo_transw.png'}  alt="peacefull painting logo"/> Peacefull Painting</a>
